...
- [ ] Enable Dependabot alerts/security updates, secret scanning, push protection, and private vulnerability reporting where available. The repository API still reports Dependabot security updates and secret scanning/push protection disabled; private reporting was not verified. The Dependency graph now supports Dependency Review, which identified the pytest advisory on PR #7.
